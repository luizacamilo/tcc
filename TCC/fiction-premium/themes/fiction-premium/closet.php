...
//Categorias
$sqlCateg = mysqli_query($conn, "SELECT * FROM tbcategoria, tbroupa where tbcategoria.id_categ = tbroupa.id_categ GROUP BY nome_categ");


//Cores
$sqlCor = mysqli_query($conn, "SELECT cor_roupa FROM tbroupa where id_user = '".$id."' GROUP BY cor_roupa");
