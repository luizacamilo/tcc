...
//Agenda
$sqlAgenda = mysqli_query($conn,"SELECT * FROM tbagendamento where id_user ='".$id."' and data_agenda > CURRENT_TIMESTAMP() ORDER BY data_agenda");
    ...
    <div class="agenda">
      ...
      <div class="section-agenda row">
        <div class="col-sm-4 d-flex section-content">
          <h3 class="data"><?php echo $rsAgenda["data_agenda"] ?></h3>
        </div>
        <div class="col-sm-4 d-flex section-content">
          <div class="section-alt">
            <p class="nome-evento"><?php echo $rsAgenda["evento_agenda"] ?></p>
            <div class="functions-look">
              <a class="blog-hiperlink" href="alteracaoLook.php?idagenda=<?php echo $rsAgenda["id_agenda"] ?>">Alterar</a>
              <a class="blog-hiperlink" href="deletar.php?op=look&idagenda=<?php echo $rsAgenda["id_agenda"] ?>" onclick="return confirm('Tem certeza que deseja deletar este look?')">Deletar</a>
            </div>
          </div>
        </div>
