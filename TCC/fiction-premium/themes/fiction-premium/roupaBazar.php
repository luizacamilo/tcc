...
//Informações Usuário
$sqlUser = mysqli_query($conn,"SELECT email_user, nome_user from tbroupa, tbusuario where tbroupa.id_user = tbusuario.id_user and id_roupa = '".$idroupa."'");
  	...
  	<div class="container">
          ...
          <div class="blog-single-content">
            <div class="blog-content-description">
              <a class="btn btn-default btn-main btn-closet" href="bazar.php" role="button">Voltar</a>
							<!-- Header -->
              <h3 class="blog-inner-heading roupa-title"><?php echo $rsRoupa["nome_roupa"] ?></h4>
              <h4 class="blog-inner-heading roupa-title">Enviado por: <?php echo $rsUser["nome_user"] ?></h4>
							<!-- Conteúdo -->
							<div class="roupa-info">
								<div class="img">
									...
									<h4 class="blog-inner-heading roupa-title-vendedor">Tem interesse? Converse com o vendedor:</h4> 
									<h4 class="blog-inner-heading roupa-title-vendedor roupa-title-vendedor-email"> <?php echo $rsUser["email_user"] ?></h4>
                </div>
								</br>
								<div class="info">
									<div class="blog-content-description">
