            ...
            <form class="measuring-form" method="post" action="gravaMedida.php?opcao=2">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input value="<?php echo $rsMedidas["altura"] ?>" type="text" name="altura" class="form-control">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Largura dos Ombros:</label>
                  <input value="<?php echo $rsMedidas["largura_ombros"] ?>" type="text" name="largura_ombros" class="form-control" placeholder="">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Busto:</label>
                  <input value="<?php echo $rsMedidas["busto"] ?>" type="text" name="busto" class="form-control" placeholder="">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Cintura:</label>
                  <input value="<?php echo $rsMedidas["cintura"] ?>" type="text" name="cintura" class="form-control" placeholder="">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Quadril:</label>
                  <input value="<?php echo $rsMedidas["quadril"] ?>" type="text" name="quadril" class="form-control" placeholder="">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Tamanho do Sapato:</label>
                  <input value="<?php echo $rsMedidas["pe"] ?>" type="text" name="pe" class="form-control" placeholder="">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Comprimento dos Braço:</label>
                  <input value="<?php echo $rsMedidas["comprimento_bracos"] ?>" type="text" name="comprimento_bracos" class="form-control" placeholder="">
                </div>
                </br>
                <div class="form-group">
                  <label class="label-form">Altura das Pernas:</label>
                  <input value="<?php echo $rsMedidas["altura_pernas"] ?>" type="text" name="altura_pernas" class="form-control" placeholder="">
                </div>
