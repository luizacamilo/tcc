...
//Roupas no Bazar
$sqlRoupa = mysqli_query($conn,"SELECT * FROM tbroupa where id_user ='".$id."' and bazar = 'S'");

//Null
$sqlNull = mysqli_query($conn,"SELECT * FROM tbroupa WHERE id_user = '".$id."' and bazar = 'S'");
...
<section class="content">
  <div class="container">
    <div class="null-case">
      ...
      if(is_null($rsNull)){
      ?>
      <h4 class="null-text">Tem alguma roupa que sabe que não vai usar nunca? Que tal lucrar um pouco com isso?</h4>
      </br>
      <a class="btn btn-default btn-main" href="closet.php" role="button">Ver seu Closet</a>
      <?php
      } 
      else{
      ?>
