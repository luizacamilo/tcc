...
<section class="services">
  <div class="container">
    <form class="look-form" method="post" action="gravaLook.php?opcao=2&idagenda=<?php echo $rsLook["id_agenda"] ?>">
      ...
      <div class="info-looks-form">
        <div class="form-group">
					...
					<input value="<?php echo $rsLook["evento_agenda"] ?>" type="text" name="evento_agenda" class="form-control" style="text-transform: capitalize">
				</div>

        <div class="form-group">
					<label class="label-form">Data:</label>
					<input value="<?php echo $rsLook["data_agenda"] ?>" type="date" name="data_agenda" class="form-control">
				</div>
