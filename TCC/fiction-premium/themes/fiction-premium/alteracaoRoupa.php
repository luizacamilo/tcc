									...
									<div class="col-md-6">
										<div class="clothes-info">
											<div class="form-group">
												...
												<input value="<?php echo $rsRoupaInfo["nome_roupa"] ?>" type="text" name="nome_roupa" class="form-control" style="text-transform: capitalize">
											</div>
											</br>
                      <div class="form-group">
                        ...
                        <?php while($rsCateg = mysqli_fetch_array($sqlCateg)){ ?>
                          ...
                          <?php if($rsRoupaInfo["id_categ"]==$rsCateg["id_categ"]){?>
                            <input type="radio" name="categ_roupa" class="radio" value="<?php echo $rsCateg["id_categ"] ?>" checked> 
                        ...
                        <?php } ?>
											...
											<div class="form-group">
												...
												<input value="<?php echo $rsRoupaInfo["cor_roupa"] ?>" type="text" name="cor_roupa" class="form-control" style="text-transform: capitalize">
											</div>
											</br>
											<div class="form-group">
												<label class="label-form">Tamanho da Peça:</label>
												<input value="<?php echo $rsRoupaInfo["tamanho_roupa"] ?>" type="text" name="tamanho_roupa" class="form-control" style="text-transform:uppercase">
											</div>
											</br>
											<div class="form-group">
												<label class="label-form">Descrição da Peça:</label>
												<textarea class="form-control" name="descricao_roupa" rows="3" ><?php echo $rsRoupaInfo["descricao_roupa"] ?> </textarea>
											</div>
											</br>
											<div class="">
                        <div class="tag-group">
